jQuery(function($) {
     ...
     *
     *******************************************************************/
    update_entry_image_fullscreen();
    function update_entry_image_fullscreen() {
        if ( $('.entry-image--fullscreen').length ) {
            $('.entry-image--fullscreen').css('height', 'calc(100vh - ' + $('.entry-image--fullscreen').offset().top + 'px)');
        }
    }
    setTimeout(update_entry_image_fullscreen, 300);
    setTimeout(update_entry_image_fullscreen, 1000);


    /********************************************************************
     * Lightbox
     *******************************************************************/
    if ( settings_array.lightbox_display == true ) {
     ...
     * Sticky sidebar
     *******************************************************************/
    if ( width >= 992 && settings_array.sidebar_fixed == true ) {
        $('.js-sticky-sidebar').stick_in_parent({'offset_top': 20});
    ...
    function sticky_footer() {
        var width = $(window).width();
        if ( width >= 992 ) {
            $('body').css('margin-bottom', $('.site-footer-container').outerHeight());
        } else {
    ...
    $('.js-search-icon').on('click', function(){
        ...
        if ( $('#site-navigation-mobile').is(':visible') ) {
            $hamburger.toggleClass('open');
            $placeholder.find('#site-navigation-mobile').slideToggle();
        }

        var $search_screen = $('.js-search-screen');
        var $search_overlay = $('.js-search-screen-overlay');
        var $this = $(this);
        var $body = $('body');

        if ( $search_screen.is(':visible') ) {
            ...
            $search_screen.find('.search-field').focus();
            ...
            var scroll_width = $body.outerWidth() - body_width;
            $body.css('padding-right', scroll_width + 'px');

        }
    });
    $('.js-search-screen-overlay').on('click', function(){
        hide_search();
    });
    function hide_search() {
        ...
        $('.js-search-icon').removeClass('close');
    ...
    if ( $('#site-navigation').length ) {
        ...
        $dump_menu = $('<nav id="site-navigation-mobile" class="main-navigation fixed"><div class="main-navigation-inner full"><div><ul id="header_menu" class="menu"></ul></div></div></nav>');
        $header_menu = $dump_menu.find('#header_menu');

        console.log($header_menu);
    }
    var $top_menu = $('#top-menu');
    var $sidebar_menu = $('.widget-mobile-menu ul');
    var $placeholder = $('.js-mobile-menu-placeholder');
    ...
    if ( $('#site-navigation').length ) {
        $placeholder.append($menu.clone().attr('id', 'site-navigation-mobile'));
    } else {
        $placeholder.append($dump_menu.clone().attr('id', 'site-navigation-mobile'));
    }

    $hamburger.on('click', function(){
        if ( $('.js-search-screen').is(':visible') ) {
            hide_search();
        }
        $hamburger.toggleClass('open');
        $placeholder.toggleClass('open').find('#site-navigation-mobile').slideToggle();
    });
    ...
    if ( width > 991 ) {
        ...
        $('.main-navigation, .top-menu').each(function(){
            var $this = $(this);
            var timer;

            $this.find('.menu-item a, .menu-item .removed-link').on('mouseenter', function () {
    ...
    $('.widget_nav_menu').on('click', '.menu-item-has-children', function (e) {
        if ( e.target.nodeName != 'A' && e.target.nodeName != 'a' ) {
            e.stopPropagation();
            $(this).toggleClass('open');
            $(this).find('.sub-menu:first').slideToggle();
...
(function(window, document, $) {
    ...
    $.fn.wpshoplightbox = function(options) {
        ...
        $this.on('click', function(){
            ...
            if ( image_src.match(/(\.jpg|\.gif|\.jpeg|\.png)$/i) ) {
...
document.querySelectorAll('[data-counter="vkontakte"]'),d="https://vk.com/share.php?act=count&index=1&url=".concat(this.url);window.VK=Object.assign({},{Share:{}},window.VK);0<b.length&&(window.VK.Share.count=function(f,d){p(b).forEach(function(a){a.innerHTML=wpshop_empty(d)});null!==a.parentNode&&a.parentNode.removeChild(a)},a.src=d,document.body.appendChild(a))}}]);return b}(e),x=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,f=1<arguments.length&&
...
''});null!==a.parentNode&&a.parentNode.removeChild(a)},a.src=c,document.body.appendChild(a))}}]);return b}(e),y=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,f=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.title;h(this,b);var d=n(this,k(b).call(this));d.url=encodeURIComponent(a);d.title=encodeURIComponent(f);d.createEvents=d.createEvents.bind(l(d));return d}m(b,c);g(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?
...
d="https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref=".concat(this.url);window.ODKL={};0<b.length&&(window.ODKL.updateCount=function(f,d){p(b).forEach(function(a){a.innerHTML=wpshop_empty(d)});null!==a.parentNode&&a.parentNode.removeChild(a)},a.src=d,document.body.appendChild(a))}}]);return b}(e),z=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,f=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.title,d=2<arguments.length&&void 0!==arguments[2]?
...
return this.createEvents(a)}},{key:"getCounter",value:function(){var a=document.createElement("script"),b=encodeURIComponent(this.url.replace(/^.*?:\/\//,"")),d=("goodshare_"+Math.random()).replace(".",""),c=document.querySelectorAll('[data-counter="moimir"]');0<c.length&&(window[d]=function(b){p(c).forEach(function(a){a.innerHTML=wpshop_empty(b.share_mm)});null!==a.parentNode&&a.parentNode.removeChild(a)},a.src="https://appsmail.ru/share/count/"+b+"?callback="+d,document.body.appendChild(a))}}]);return b}(e),
...
b.count:''});null!==a.parentNode&&a.parentNode.removeChild(a)},a.src=c,document.body.appendChild(a))}}]);return b}(e),C=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,f=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.title;h(this,b);var d=n(this,k(b).call(this));d.url=encodeURIComponent(a);d.title=encodeURIComponent(f);d.createEvents=d.createEvents.bind(l(d));return d}m(b,c);g(b,[{key:"getPreparedData",value:function(a){var b=
...
b?b.shares:''});a.parentNode.removeChild(a)},a.src=c,document.body.appendChild(a))}}]);return b}(e),E=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,f=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.title;h(this,b);var d=n(this,k(b).call(this));d.url=encodeURIComponent(a);d.title=encodeURIComponent(f);d.createEvents=d.createEvents.bind(l(d));return d}m(b,c);g(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?
